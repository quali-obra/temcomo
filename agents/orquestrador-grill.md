...
- **Não grave nem aceite artefato do grill fora da pasta da tarefa** (`/tmp`, scratchpad, `Downloads`, worktree de subagente): o que fica lá some com a sessão e deixa de ser referência.
